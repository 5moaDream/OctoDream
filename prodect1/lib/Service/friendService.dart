...
Future<List<Friend>> fetchFriend() async {
  ...
  Map<String, String> headers = {
    ...
    var url = Uri.parse('http://3.39.126.140:8000/user-service/kakao-friends/$kakaoToken?offset=0');
...
class Friend {
  ...
  final characterImageUrl; // 친구 문어 이미지
  final thumbnailImageUrl; // 친구 프로필 사진
